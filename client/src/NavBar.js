     ...
     return (
        <div style={{height: "60px"}} className="nav-bar">
            ...
            <div style={{marginLeft: "10px", marginRight: "10px"}}>
                <img alt="user"  className="hello-image"src={user.image} style={{borderRadius: "28px", marginRight:"10px", width:"40px", marginLeft:"10px"}}/>
                ...
                <button className="btn btn-dark" style={{backgroundColor: "black", borderColor: "black", color: "rgb(228, 124, 124)", float:"right", fontWeight: "bold", marginRight: "10px"}} onClick={handleLogout}>Log Out</button>  
                </div>
                :
